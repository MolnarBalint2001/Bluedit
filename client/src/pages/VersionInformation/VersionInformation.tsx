...
const VersionInformation = () => {
    ...
    return <>
        <div className={"text-2xl font-semibold"}>Bluedit v1.0.0 information</div>
        <Divider/>
        <Accordion activeIndex={0} multiple className={"mt-4"}>
            <AccordionTab header="Sign up">
                <p className="m-0">
